...
public final class ConnectionPool {
	...
	public Connection takeConnection() throws ConnectionException {
        ...
        public void closeConnection(Connection con, Statement st, ResultSet rs) throws ConnectionException {
		try {
			con.close();
		} catch (SQLException e) {
			// logger.log(Level.ERROR, "Connection isn't return to the pool.");
                        
                        throw new ConnectionException("can't return to the pool", e);
		}
