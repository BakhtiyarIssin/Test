...
public final class ConnectionPool_ {
	...
	private ConnectionPool_() {
        ...
        public static ConnectionPool_ getInstance()
        {
            return new ConnectionPool_();
	...
	public void initPoolData() throws ConnectionException {
		...
		try {
			...
			throw new ConnectionException("SQLException in ConnectionPool",
					e);
	...
	public void dispose()    {
            try {
                ...
                Logger.getLogger(ConnectionPool_.class.getName()).log(Level.SEVERE, null, ex);
            }
	}
	...
	private void clearConnectionQueue() throws ConnectionException {
		try {
			...
			throw new ConnectionException("Error clear connection queue",e);
		}
	}
